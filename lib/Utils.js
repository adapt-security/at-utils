...
export default class Utils {
  static async loadPackage(root, relPath = '') {
    if(root.startsWith('file:')) {
      root = path.dirname(new URL(root).pathname);
    }
    return this.loadJson(path.resolve(root, relPath, 'package.json'));
  }
  static async importCore(root) {
    return import(path.resolve(root, 'node_modules/adapt-authoring-core/index.js'));
  }
