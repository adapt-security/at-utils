...
export default class Installer {
  ...
  async install () {
    ...
    await downloadRelease({ tag: this.options.tag, targetDir: this.options.cwd, repo: this.options.repo })
  }
  ...
  async update () {
    ...
    await downloadRelease({ tag: this.options.tag, targetDir: stagingDir, repo: this.options.repo })
